...
class WanTrainingModule(DiffusionTrainingModule):
    def __init__(
        ...
        if force_i2v_fuse:
            self.pipe.dit.fuse_vae_embedding_in_latents = True
            self.pipe.dit.require_vae_embedding = False
...
def wan_parser():
    ...
    parser.add_argument("--force_i2v_fuse", action="store_true", help="Force fuse_vae_embedding_in_latents and disable VAE embedding channels (I2V style).")
...
if __name__ == "__main__":
    ...
    model_logger = ModelLogger(
        ...
        checkpoint_weights_name=checkpoint_weights_name,
    )
    launcher_map = {
